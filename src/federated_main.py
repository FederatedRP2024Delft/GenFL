...
if __name__ == '__main__':
    ...
    if os.path.exists(model_dict_path):
        global_model.load_state_dict(model_dict_path)
    else:
    ...
    torch.save(global_model.state_dict(), f"../models/federated_{args.model}_{args.dataset}_{args.iid}_{args.dirichlet}_{args.epochs}_{args.local_ep}_{args.num_users}.pt")
